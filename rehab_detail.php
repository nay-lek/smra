                ...
                <div class="row">
                    <div class="col-lg-12">
                       <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="rehab_index.php?vn=<?=$vn4digit;?>">แสดงข้อมูล REHABILITATION   <?php echo get_month_show($vn4digit); ?></a></li>
                                        ...
                                        <div class="col-md-12"> 
                                            <div class="bs-callout bs-callout-defult" style="border-bottom: dashed 1px #FF00FF;" >
                                                 <div class="list-group">
                                                    <?=get_rows_Rehab_Error_detail_list($_SESSION['err'],$_SESSION['vn4digit'],"No");?>
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
